...
fontScale = 0.5  # Change the font scale to make the text smaller
fontThickness = 1  # Change the font thickness if needed
vehicles = []
max_p_age = 5
pid = 1
...
while(cap.isOpened()):
    ...
    cv2.putText(frame, MTR_up, (10, 40), font, fontScale, (255, 255, 255), fontThickness, cv2.LINE_AA)
    cv2.putText(frame, MTR_up, (10, 40), font, fontScale, (0, 0, 255), fontThickness, cv2.LINE_AA)
    cv2.putText(frame, LV_up, (10, 90), font, fontScale, (255, 255, 255), fontThickness, cv2.LINE_AA)
    cv2.putText(frame, LV_up, (10, 90), font, fontScale, (0, 0, 255), fontThickness, cv2.LINE_AA)
    cv2.putText(frame, HV_up, (10, 140), font, fontScale, (255, 255, 255),fontThickness, cv2.LINE_AA)
    cv2.putText(frame, HV_up, (10, 140), font, fontScale, (0, 0, 255), fontThickness, cv2.LINE_AA)
    ...
    cv2.putText(frame, LV_down, (10, 190), font, fontScale, (255, 255, 255), fontThickness, cv2.LINE_AA)
    cv2.putText(frame, LV_down, (10, 190), font, fontScale, (255, 0, 0), fontThickness, cv2.LINE_AA)
    cv2.putText(frame, HV_down, (10, 240), font, fontScale, (255, 255, 255), fontThickness, cv2.LINE_AA)
    cv2.putText(frame, HV_down, (10, 240), font, fontScale, (255, 0, 0), fontThickness, cv2.LINE_AA)
